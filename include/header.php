<header class="header menu_2">
		...
		<ul id="top_menu">
			...
			<li class="hidden_tablet"><a href="admission_form.php" class="btn_1 rounded">Admission</a></li>
		</ul>
		<!-- /top_menu -->
 ...
 -->				</li>
				<li><span><a href="courses.php">Courses</a></span>
					<!-- <ul>
				...
				<li><span><a href="#0">About</a></span>
					<ul>
						...
						<li><a href="rules-n-regulation.php">Rules & Regulation</a></li>
				...
				<li><span><a href="#0">Enquiry</a></span>
					<ul>
